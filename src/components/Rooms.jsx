  ...
  return (
    <div className='max-w-[1400px] h-[500px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4'>
        <div className='lg:top-20 relative lg:col-span-1 col-span-2'>
            ...
            <p className='pt-4'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fugit suscipit eligendi enim? Laborum, incidunt commodi!</p>
        ...
        <div className='grid grid-cols-2 col-span-2 gap-2'>
            ...
            <img src="https://images.unsplash.com/photo-1582719478250-c89cae4dc85b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2340&q=80" alt="/" />
