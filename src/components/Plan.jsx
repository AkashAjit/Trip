  ...
  return (
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="grid grid-cols-2 grid-rows-6 h-[80vh]">
        <img className="object-cover w-full h-full p-2 row-span-3"
          ...
          alt="/"
        />
        <img className="object-cover w-full h-full p-2 row-span-2"
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="text-2xl py-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Culpa, illo?</p>
        <p className="pb-6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur laborum sequi aspernatur asperiores cumque quibusdam molestiae praesentium ad a, est libero veritatis vero minus pariatur quaerat sapiente quia amet vitae.</p>
        <div>
